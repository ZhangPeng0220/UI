...
public class MainActivity extends FragmentActivity implements View.OnClickListener {
    ...
    private void initEvent() {
        ...
        mImageViewFrd.setOnClickListener(this);
        mImageViewFind.setOnClickListener(this);
        ...
        mViewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {//ViewPager滑动切换监听
            ...
            public void onPageSelected(int arg0) {
                ...
                switch (currentItem) {
                    case 0:
                        mImageViewChat.setImageResource(R.drawable.first);
                        break;
                    case 1:
                        mImageViewFrd.setImageResource(R.drawable.person);
                        break;
                    case 2:
                        mImageViewFind.setImageResource(R.drawable.set);
                        break;
                    default:
                        break;
                }
    ...
    private void resetImag() {//重置图片
        mImageViewChat.setImageResource(R.drawable.first_no);
        mImageViewFrd.setImageResource(R.drawable.person_no);
        mImageViewFind.setImageResource(R.drawable.set_no);
